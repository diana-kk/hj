...
var t6 = blinkArea.text(180, 330, '江').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt6 = blinkArea.text(180, 500, '강 강').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t7 = blinkArea.text(180, 330, '沙').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt7 = blinkArea.text(180, 500, '모래 사').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t8 = blinkArea.text(180, 330, '酒').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt8 = blinkArea.text(180, 500, '술 주').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t9 = blinkArea.text(180, 330, '冷').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt9 = blinkArea.text(180, 500, '찰 랭').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t10 = blinkArea.text(180, 330, '氷').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt10 = blinkArea.text(180, 500, '얼음 빙').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t11 = blinkArea.text(180, 330, '回').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt11 = blinkArea.text(180, 500, '돌 회').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t12 = blinkArea.text(180, 330, '因').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt12 = blinkArea.text(180, 500, '인할 인').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t13 = blinkArea.text(180, 330, '國').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt13 = blinkArea.text(180, 500, '나라 국').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t14 = blinkArea.text(180, 330, '園').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt14 = blinkArea.text(180, 500, '동산 원').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t15 = blinkArea.text(180, 330, '圓').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt15 = blinkArea.text(180, 500, '둥글 원').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t16 = blinkArea.text(180, 330, '充').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt16 = blinkArea.text(180, 500, '찰 충').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t17 = blinkArea.text(180, 330, '者').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt17 = blinkArea.text(180, 500, '놈 자').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t18 = blinkArea.text(180, 330, '要').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt18 = blinkArea.text(180, 500, '중요할 요').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t19 = blinkArea.text(180, 330, '重').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt19 = blinkArea.text(180, 500, '무거울 중').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t20 = blinkArea.text(180, 330, '幸').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt20 = blinkArea.text(180, 500, '다행 행').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t21 = blinkArea.text(180, 330, '第').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt21 = blinkArea.text(180, 500, '차례 제').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t22 = blinkArea.text(180, 330, '答').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt22 = blinkArea.text(180, 500, '대답할 답').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t23 = blinkArea.text(180, 330, '等').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt23 = blinkArea.text(180, 500, '무리 등').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t24 = blinkArea.text(180, 330, '笑').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt24 = blinkArea.text(180, 500, '웃을 소').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});

var t25 = blinkArea.text(180, 330, '算').attr({
  'fill': 'none',
  'font-size': 200,
  'text-anchor': 'middle'
});
var tt25 = blinkArea.text(180, 500, '셈할 산').attr({
  'fill': 'none',
  'font-size': 70,
  'text-anchor': 'middle'
});
